...
class HomeViewController: UIViewController {
    ...
    var sideMenutitleArray: NSArray = ["BOOK A FLIGHT", "MANAGE BOOKING", "MY BOOKING" ,"WEB CHECK-IN" , "HOLIDAYS", "FLIGHT STATUS", "SKY STAR", "SALES OFFICES", "CONTACT US"]
...
//            }
            ...
            case .success:
                self.home = response.result.value?.item?.home
