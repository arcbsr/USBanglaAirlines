...
struct CustomColor{
    static let primaryColor = UIColor(red: 0/255, green: 49/255, blue: 165/255, alpha: 1.0)
    static let secondaryColor = UIColor(red: 225/255, green: 0/255, blue: 0/255, alpha: 1.0)
}
...
//        let testAuthKeyOld = "_JEAAAAL436mpPsYP3m2lwfwBiLPdzcUQEHyecX5mtHR1RMK0DTHTEiyA_EYVUazFkn3rIGIGu6wxA8qa1gYyfs1uOib4E_U"
        let testAuthKey = "_JEAAAAJ8JarNnf75q7kW3KS1cpX64kQlkkoqBHHd57csnF8wH83k_EgnCTpYwEghQknu0wvs7CWg2JXug3xbvXkmJboHg_U"
    ...
    static func getBaseUrl() -> String{
        let testUrl = "http://tstws2.ttinteractive.com" // https://tstws2.ttinteractive.com
...
public enum GivenOption {
    case bookingFlight, skyStarSignUp, skyStarLogin, hotline, manageBooking, holiday, flightSchedule, webCheckIn, liveFlightSearch, myBooking, salesOffice
}
